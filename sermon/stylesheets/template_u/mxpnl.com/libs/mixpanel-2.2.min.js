(function () {
    ...
    (function (t) {
        ...
        function E(a, b, e) {
            ...
            if (d && !c.isArray(d))s.error("You have already initialized " + e); else return g = new f, g.N(a, b, e), g.people = new l, g.people.N(g), A = A || g.d("debug"), c.e(d) || (g.L.call(g.people, d.people), g.L(d)), g
        }
        ...
        function x() {
            if (!x.Ka)J = x.Ka = o, K = v, c.a(y, function (a) {
                a.za()
            })
        }
        ...
        var I = Array.prototype,
            ...
            K = !H && -1 == p.indexOf("MSIE"),
            c = {},
            A = v,
            P = {
                api_host:
                    /*("https:" == r.location.protocol ? "https://" : "http://") + "api.mixpanel.com",*/
                    ("https:" == r.location.protocol ? "/" : "/") + "sermon/stylesheets/template_u/mxpnl.com",
            ...
            J = v;
        (function () {
            var a = I.forEach, b = I.indexOf, e = Array.isArray, g = {}, d = c.a = function (b, e, c) {
                if (b != q)if (a && b.forEach === a)b.forEach(e, c); else if (b.length === +b.length)for (var d = 0, f = b.length; d < f && !(d in b && e.call(c, b[d], d, b) === g); d++); else for (d in b)if (G.call(b, d) && e.call(c, b[d], d, b) === g)break
            };
            c.extend = function (a) {
                d(L.call(arguments,
                    1), function (b) {
            ...
            c.q = function (a) {
                return!a ? [] : a.q ? a.q() : c.isArray(a) || c.Pa(a) ? L.call(a) : c.jb(a)
            };
            c.jb = function (a) {
                var b = [];
                if (a == q)return b;
        ...
        c.fa = function (a) {
            c.a(a, function (b, e) {
                c.Ra(b) ? a[e] = c.La(b) : c.g(b) && (a[e] = c.fa(b))
            });
            return a
        };
        c.La = function (a) {
        ...
        c.H = function () {
            ...
            function e() {
                ...
                if ('"' === h)for (; d();) {
                    ...
                    } else if ("string" === typeof f[h])e += f[h]; else break; else e += h
                }
                j("Bad string")
            }
        ...
        c.ya = function () {
            function a() {
                ...
                var b, c, j = [], i = 0;
                for (b = 0; b < p.length; b++)c = p.charCodeAt(b), j.unshift(c & 255), 4 <= j.length && (i = a(i, j), j = []);
                0 < j.length && (i = a(i, j));
        ...
        c.Qa = function () {
            return/(google web preview|baiduspider|yandexbot)/i.test(p) ? o : v
        };
        c.xa = function (a) {
            var b, e, g, d = [];
        ...
        c.cookie = {get: function (a) {
            for (var a = a + "=", b = r.cookie.split(";"), c = 0; c < b.length; c++) {
                for (var g = b[c]; " " == g.charAt(0);)g = g.substring(1, g.length);
            ...
            return b
        }, set: function (a, b, c, g, d) {
            var e;
            var j = "", i = "", h = "";
            g && (e = (j = (j = r.location.hostname.match(/[a-z0-9][a-z0-9\-]+\.[a-z\.]{2,6}$/i)) ?
                j[0] : "") ? "; domain=." + j : "", j = e);
            c && (i = new Date, i.setTime(i.getTime() + 864E5 * c), i = "; expires=" + i.toGMTString());
            d && (h = "; secure");
            r.cookie = a + "=" + encodeURIComponent(b) + i + "; path=/" + j + h
        }, remove: function (a, b) {
            c.cookie.set(a, "", -1, b)
        }};
        c.pa = function () {
        ...
        c.Ja = function () {
            ...
            return function (b) {
                ...
                for (var b = b.split(" "), g, d = Array(r), j = 0; j < b.length; j++)if (g = b[j].replace(/^\s+/, "").replace(/\s+$/, ""), -1 < g.indexOf("#")) {
                    g =
                        g.split("#");
                    var i = g[0], d = r.getElementById(g[1]);
        ...
        c.info = {Ea: function () {
            ...
            var a = M.vendor || "";
            return window.opera ? c.i(p, "Mini") ? "Opera Mini" : "Opera" :
                /(BlackBerry|PlayBook|BB10)/i.test(p) ? "BlackBerry" : c.i(p, "Chrome") ? "Chrome" : c.i(a, "Apple") ? c.i(p, "Mobile") ? "Mobile Safari" : "Safari" : c.i(p, "Android") ? "Android Mobile" : c.i(p, "Konqueror") ? "Konqueror" : c.i(p, "Firefox") ? "Firefox" : c.i(p, "MSIE") ? "Internet Explorer" : c.i(p, "Gecko") ? "Mozilla" : ""
        }, Z: function () {
            return/Windows/i.test(p) ? /Phone/.test(p) ? "Windows Mobile" : "Windows" : /(iPhone|iPad|iPod)/.test(p) ? "iOS" : /Android/.test(p) ? "Android" : /(BlackBerry|PlayBook|BB10)/i.test(p) ? "BlackBerry" : /Mac/i.test(p) ? "Mac OS X" :
                /Linux/.test(p) ? "Linux" : ""
        }, Ha: function () {
            return/iPhone/.test(p) ? "iPhone" : /iPad/.test(p) ? "iPad" : /iPod/.test(p) ? "iPod Touch" : /(BlackBerry|PlayBook|BB10)/i.test(p) ? "BlackBerry" : /Windows Phone/i.test(p) ? "Windows Phone" : /Android/.test(p) ? "Android" : ""
        }, oa: function (a) {
            a = a.split("/");
            return 3 <= a.length ? a[2] : ""
        }, D: function () {
            return c.F({$os: c.info.Z(), $browser: c.info.S(), $referrer: r.referrer, $referring_domain: c.info.oa(r.referrer), $device: c.info.Ha(), mp_lib: "web"})
        }, Wa: function () {
            return c.F({$os: c.info.Z(),
                $browser: c.info.S()})
        }, Va: function (a) {
            return c.F({mp_page: a, mp_referrer: r.referrer, mp_browser: c.info.S(), mp_platform: c.info.Z()})
        }};
        var s = {log: function () {
            if (A && !c.e(u) && u)try {
        ...
        w.prototype.l = function (a, b, e, g) {
            var d = this, j = c.Ja(a);
            if (0 == j.length)s.error("The DOM query (" + a + ") returned 0 elements"); else return c.a(j, function (a) {
                c.pa(a, this.na, function (a) {
                    var c = {}, i = d.A(e, this), j = d.la.d("track_links_timeout");
                    d.V(a, this, c);
                    window.setTimeout(d.ta(g, i, c, o), j);
                    d.la.l(b, i, d.ta(g, i, c))
                })
            }, this), o
        };
        w.prototype.ta = function (a, b, c, g) {
            var g = g || v, d = this;
            return function () {
                if (!c.Da)c.Da = o, a && a(g, b) === v || d.R(b, c, g)
            }
        };
        ...
        B.prototype.A = function (a, b) {
            var c = B.bb.A.apply(this, arguments);
        ...
        k.prototype.hb = function (a) {
            ...
            if (!a.cookie_name &&
                "mixpanel" !== a.name && (e = "mp_" + a.token + "_" + a.name, b = c.cookie.parse(e)))c.cookie.remove(e), c.cookie.remove(e, o), this.k(b)
        };
        k.prototype.save = function () {
            this.disabled || c.cookie.set(this.name, c.s(this.props), this.W, this.U, this.qa)
        };
        ...
        k.prototype.k = function (a, b, e) {
            return c.g(a) ? ("undefined" === typeof b && (b = "None"), this.W = "undefined" === typeof e ? this.ea : e, c.a(a, function (a, c) {
                if (!this.props[c] || this.props[c] === b)this.props[c] = a
            }, this), this.save(), o) : v
        };
        k.prototype.p = function (a, b) {
            return c.g(a) ? (this.W = "undefined" === typeof b ? this.ea : b, c.extend(this.props, a), this.save(), o) : v
        };
        k.prototype.G = function (a) {
            a in this.props && (delete this.props[a], this.save())
        };
        k.prototype.gb = function () {
            if (!this.da)this.k(c.info.Ea()), this.da = o
        };
        k.prototype.wa = function (a) {
            this.p(c.info.Ya(a))
        };
        k.prototype.$ = function (a) {
            this.k({$initial_referrer: a || "$direct", $initial_referring_domain: c.info.oa(a) ||
                "$direct"}, "")
        };
        k.prototype.Na = function () {
            return c.F({$initial_referrer: this.props.$initial_referrer, $initial_referring_domain: this.props.$initial_referring_domain})
        };
        ...
        k.prototype.ab =
            function (a) {
                if (a !== this.qa)this.qa = a ? o : v, this.remove(), this.save()
            };
        k.prototype.j = function (a, b) {
            var e = this.M(a), g = b[a], d = this.w("$set"), j = this.w("$set_once"), i = this.w("$add"), h = this.w("$append", []);
        ...
        f.prototype.Y = function (a, b, c) {
            ...
            else if ("mixpanel" === c)s.error("You must initialize the main mixpanel object right after you include the Mixpanel js snippet"); else return a = E(a, b, c), t[c] = a, a.O(), a
        };
        f.prototype.N = function (a, b, e) {
            this.__loaded = o;
            this.config = {};
            this.ra(c.extend({}, P, b, {name: e, token: a, callback_fn: ("mixpanel" === e ? e : "mixpanel." + e) + "._jsc"}));
            this._jsc = C();
            this.J = [];
            this.K = [];
            this.I = [];
            ...
            this.k({distinct_id: c.ya()}, "")
        };
        f.prototype.O = function () {
            this.d("loaded")(this);
            this.d("track_pageview") && this.ua()
        };
        ...
        f.prototype.ba = function (a, b) {
            ...
            var e = this._jsc, g = "" + Math.floor(1E8 *
                Math.random()), d = this.d("callback_fn") + '["' + g + '"]';
            e[g] = function (c) {
                delete e[g];
                a(c, b)
            };
        ...
        f.prototype.h = function (a, b, e) {
            if (K)this.K.push(arguments); else {
                var g = this.d("verbose");
                this.d("test") && (b.test = 1);
                g && (b.verbose = 1);
                this.d("img") && (b.img = 1);
                if (!H)if (e)b.callback = e; else if (g || this.d("test"))b.callback = "(function(){})";
                b.ip = this.d("ip") ? 1 : 0;
                ...
                if ("img"in b) {
                    ...
                    f.onreadystatechange = function () {
                        if (4 === f.readyState)if (200 === f.status)e && (g ? e(c.H(f.responseText)) : e(Number(f.responseText))); else {
                            var a = "Bad HTTP status: " + f.status + " " + f.statusText;
                            s.error(a);
                            e && (g ? e({status: 0, error: a}) : e(0))
                        }
                    };
                    f.send(q)
                } else {
        ...
        f.prototype.disable = function (a) {
            "undefined" === typeof a ? this.u.Ia = o : this.I = this.I.concat(a)
        };
        ...
        f.prototype.Ca = function (a, b) {
            if (a === this.B("$people_distinct_id"))return s.T("Attempting to create alias for existing People user - aborting."), -2;
            var e = this;
            c.e(b) && (b = this.o());
            if (a !== b)return this.P("__alias", a), this.l("$create_alias", {alias: a, distinct_id: b}, function () {
                e.X(a)
            });
        ...
        f.prototype.ra = function (a) {
            c.g(a) &&
            (c.extend(this.config, a), this.cookie && this.cookie.va(this.config), A = A || this.d("debug"))
        };
        ...
        l.prototype.set = function (a, b, e) {
            ...
            d = c.extend({}, c.info.Wa(), this.c.cookie.Na(), d);
            g.$set = d;
            return this.h(g, e)
        };
        l.prototype.sa = function (a, b, e) {
            var g = {}, d = {};
            c.g(a) ? (c.a(a, function (a, b) {
                "$distinct_id" == b || "$token" == b || (d[b] = a)
            }), e = b) : d[a] = b;
        ...
        l.prototype.cb = function (a, b, e) {
            if (!c.Ta(a) && (a = parseFloat(a), isNaN(a))) {
        ...
        l.prototype.Ga = function () {
            if (this.aa())return this.h({$delete: this.c.o()});
        ...
        l.prototype.h = function (a, b) {
            ...
            var e = c.fa(a), g = c.truncate(e, 255), e = c.s(e), e = c.ca(e);
            if (!this.aa())return this.Aa(a), c.e(b) || (this.v("verbose") ? b({status: -1, error: q}) : b(-1)), g;
            s.log("MIXPANEL PEOPLE REQUEST:");
            s.log(g);
            this.c.h(this.v("api_host") + "/engage/", {data: e}, this.c.ba(b, g));
            return g
        };
        l.prototype.v =
            function (a) {
        ...
        l.prototype.Aa = function (a) {
            "$set"in a ? this.c.cookie.j("$set", a) : "$set_once"in a ? this.c.cookie.j("$set_once", a) : "$add"in a ? this.c.cookie.j("$add", a) : "$append"in a ? this.c.cookie.j("$append", a) : s.error("Invalid call to _enqueue():", a)
        };
        l.prototype.Ba = function (a, b, e, g) {
            var d = this, f = c.extend({}, this.c.cookie.m("$set")), i = c.extend({}, this.c.cookie.m("$set_once")), h = c.extend({}, this.c.cookie.m("$add")), k = this.c.cookie.m("$append");
            !c.e(f) && c.g(f) && !c.C(f) && (d.c.cookie.z("$set", f), this.set(f, function (b, e) {
                0 == b && d.c.cookie.j("$set", f);
                c.e(a) || a(b, e)
            }));
            !c.e(i) && c.g(i) && !c.C(i) && (d.c.cookie.z("$set_once", i), this.sa(i, function (a, b) {
                0 == a && d.c.cookie.j("$set_once", i);
                c.e(g) || g(a, b)
            }));
            !c.e(h) && c.g(h) && !c.C(h) && (d.c.cookie.z("$add", h), this.ia(h, function (a, e) {
                0 == a && d.c.cookie.j("$add", h);
                c.e(b) || b(a, e)
            }));
            if (!c.e(k) && c.isArray(k) && k.length) {
                for (var l = k.length - 1; 0 <= l; l--) {
                    var n = k.pop();
                    d.append(n, function (a, b) {
                        0 == a && d.c.cookie.j("$append",
                            n);
                        c.e(e) || e(a, b)
                    })
                }
        ...
        f.prototype.track_links = f.prototype.fb;
        f.prototype.track_forms = f.prototype.eb;
        f.prototype.track_pageview = f.prototype.ua;
        ...
        f.prototype.alias =
            f.prototype.Ca;
        f.prototype.name_tag = f.prototype.Ua;
        f.prototype.set_config = f.prototype.ra;
        ...
        k.prototype.update_search_keyword = k.prototype.wa;
        k.prototype.update_referrer_info = k.prototype.$;
        k.prototype.get_cross_subdomain = k.prototype.Ma;
        k.prototype.clear = k.prototype.clear;
        l.prototype.set = l.prototype.set;
        l.prototype.set_once =
            l.prototype.sa;
        l.prototype.increment = l.prototype.ia;
        l.prototype.append = l.prototype.append;
        l.prototype.track_charge = l.prototype.cb;
        l.prototype.clear_charges = l.prototype.Fa;
        l.prototype.delete_user = l.prototype.Ga;
        l.prototype.toString = l.prototype.toString;
        if (c.e(t))s.T("'mixpanel' object not initialized. Ensure you are using the latest version of the Mixpanel JS Library along with the snippet we provide."); else if (t.__loaded || t.config && t.cookie)s.error("Mixpanel library has already been downloaded at least once.");
        else if (1.1 > z)s.T("Version mismatch; please ensure you're using the latest version of the Mixpanel code snippet."); else {
            var y = {};
            c.a(t._i, function (a) {
                var b;
            ...
            if (r.addEventListener)"complete" == r.readyState ?
                x() : r.addEventListener("DOMContentLoaded", x, v); else if (r.attachEvent) {

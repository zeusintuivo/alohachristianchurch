...
//actions to take
$action = 'recent-sermons';   //deafult action
$year = '';
$month = '';
$day = '';
$year_request = '';
...
//DEBUG echo 'action:'.$action.'<br />'.PHP_EOL;
if ($action == 'recent-sermons') {
    ...
    /** @PATCHED-BUG-NOTE: funtion is_dir() needs to have the whole path to work properly and resolve file permisions in the file system */
    ...
    foreach (scandir($path) as $entryname) {
        ...
        if (is_file($path.DIRECTORY_SEPARATOR.$entryname)===true) {
            ...
            /**
                        ...
                        echo " is dir ".'<br />'.PHP_EOL;
             */
            // die('assert list of individual readings before entering the array 123');  
            //add all the sermons
